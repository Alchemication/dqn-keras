...
# LOAD_FROM = './breakout-saves-experimental/save-04319620'
LOAD_FROM = None
...
MAX_EPISODE_LENGTH = 18_000       # Maximum length of an episode (in frames).  18000 frames / 60 fps = 5 minutes
FRAMES_BETWEEN_EVAL = 100_000     # Number of frames between evaluations
EVAL_LENGTH = 10_000              # Number of frames to evaluate for
UPDATE_FREQ = 10_000              # Number of actions chosen between updating the target network

DISCOUNT_FACTOR = 0.99            # Gamma, how much to discount future rewards
MIN_REPLAY_BUFFER_SIZE = 50_000   # The minimum size the replay buffer must be before we start to update the agent
MEM_SIZE = 1000_000               # The maximum size of the replay buffer
